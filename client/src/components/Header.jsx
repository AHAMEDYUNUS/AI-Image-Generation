...
const Header = () => {
    return (
        <div className="flex flex-col justify-center items-center text-center my-20 sm:my-10  lg:my-5">
            ...
            <button className="sm:text-lg w-auto text-white flex items-center gap-3 px-8 py-2.5 mt-8 bg-blue-700 rounded-full shadow-[6px_5px_1px_rgba(0,0,0,1)] active:shadow-[4px_2px_1px_rgba(0,0,0,1)] active:translate-y-1 active:translate-x-0.5">
                Generate images
