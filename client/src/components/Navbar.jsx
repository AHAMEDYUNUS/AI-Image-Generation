...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5'>
      <Link to='/'>
      <img src={assets.logo} alt="GenifAI" className='w-28 sm:w-32 lg:w-40'/>
      </Link>
      ...
      <div>
        {
          ...
          <div className='flex items-center gap-2 sm:gap-5'>
            <button onClick={()=>navigate('/buy')} className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-500'>
              <img src={assets.credit_star} className='w-5' alt=""></img>
              <p className='text-sm sm:text-xs font-medium text-gray-600'>Credits Left: 50</p>
            </button>
            <p className='text-gray-600 max-sm:hidden pl-4'>Hi, Imaginer</p>
          ...
          :
          <div className='flex items-center gap-2 sm:gap-5 md:gap-4'>
